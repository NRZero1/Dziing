...
<body id="page-top">
  ...
  <div id="wrapper">
    <!-- Sidebar -->
    <?php  $this->load->view("_includes/sidebarcom.php")  ?>
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
       <?php $this->load->view("_includes/navbarcom.php") ?>
        <!-- End of Topbar -->
        ...
        <div class="col-xl-10 offset-xl-1">
          <div class="row">
            <div class="col-lg-5">
                <img src="<?php echo base_url('img/'.$profile->photo) ?>" class="img-fluid rounded-circle" alt="<?php echo $profile->username ?>" title="<?php echo $profile->username ?>">
            </div>
            <div class="col-lg-6">
              <div>
                <h4><?php echo $profile->username ?></h4>
                <p><?php echo $profile->level ?></p><br>
              </div>
              <div>
                <h4>General Info</h4>
                <table class="table">
