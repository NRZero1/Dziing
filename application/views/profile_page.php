...
<html>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-padding">
      <a class="navbar-brand" href="#"><img src="img/Dziing_logo_Temp.png" style="width: 60px; height: 40px;"></a>
 ...
 <div class="row">
 <div class="col-lg-5">
 <img src="<?php echo base_url('img/'.$profile->photo) ?>"
class="img-fluid rounded-circle" alt="<?php echo $profile->username ?>"
title="<?php echo $profile->username ?>">
 </div>
 <div class="col-lg-6">
 <div>
 <h4><?php echo $profile->first_name ?> <?php echo $profile->last_name ?></h4>
 <p><?php echo $profile->country ?></p><br>
 </div>
 <div>
 <h4>General Info</h4>
 <table class="table">
